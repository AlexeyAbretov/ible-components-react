...
stories
  .add('Общие принципы', () => (
    <Container>
      ...
      <b>
        Данные правила и соглашения настроены в шаблоне, расположенном в git-репозитории <a href="https://git.loko-domain.ru/Git/LockoBank.Boilerplate.Styled.git" target="_blank" rel="noopener noreferrer">LockoBank.Boilerplate.Styled</a>, а также в <a href="http://wiki-dev/pages/viewpage.action?pageId=5111887" target="_blank" rel="noopener noreferrer">Вики</a>
      </b>
        ...
        {`
{
  ...
  .add('Storybook', () => (
    <Container>
      <p>В нашей команде разработку компонентов принято вести в Storybook.</p>
...
try {
  ...
  .add('Инструменты', () => (
    <Container>
      ...
      <p>
        Данные расширения должны автоматически установится при открытии проекта склонированного из <a href="https://git.loko-domain.ru/Git/LockoBank.Boilerplate.Styled.git" target="_blank" rel="noopener noreferrer">LockoBank.Boilerplate.Styled</a>.
        <img src={Extensions} alt="" />
      </p>
      <H1>Расширения разработанные в Локо-банке</H1>

      <ul>
        <li>
          <b>Набор команд для приложений ReactJS, Styled-Components, Storybook (locko-react-tools).</b><br />
          Доступно в проекте после клонирования <a href="https://git.loko-domain.ru/Git/LockoBank.Boilerplate.Styled.git" target="_blank" rel="noopener noreferrer">LockoBank.Boilerplate.Styled</a>. <br />
          <img src={ReactToolsExtensions} alt="" /><br />
          <b>Установка</b><br />
